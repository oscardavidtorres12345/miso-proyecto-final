  ...
  return (
    <>
      <BottomSheet
        isOpen={isOpen}
        onClose={onClose}
        className="search-sheet-panel"
      >
        <div className="search-sheet">
          <div className="search-sheet__field">
            <span className="search-sheet__label">
          ...
          <div
            className="search-sheet__field search-sheet__field--tap"
            onClick={openDates}
          >
            ...
            <div className="search-sheet__input-row">
              ...
              <div className="input-box flex-1">
                <span
                  className={cn(
                    "input-display",
                    !dateDisplay && "input-display--placeholder",
                  )}
                >
          ...
          >
            ...
            <div className="search-sheet__input-row">
              ...
              <div className="input-box flex-1">
                ...
                >
                  {isDraft || guestsSelected
                    ? guestDisplay
                    : t("search.howManyPlaceholder")}
                </span>
              </div>
            </div>
          </div>
