...
const SESSION_FLOAT_VIEWPORT_BOTTOM = 'calc(16px + env(safe-area-inset-bottom, 0px))'
const SESSION_FLOAT_CLEAR_FOOTER = 'calc(var(--app-footer-height) + 16px + env(safe-area-inset-bottom, 0px))'
