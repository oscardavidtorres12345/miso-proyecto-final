...
describe('HomeScreen', () => {
  it('renders without crashing', () => {
    const { toJSON } = render(<HomeScreen onNavigateToSearch={noop} />);
  ...
  it('opens SearchBottomSheet when Buscar is pressed', async () => {
    const { getByText, getByPlaceholderText } = render(<HomeScreen onNavigateToSearch={noop} />);
  ...
  it('fires onContentSizeChange updating background height', () => {
    const { UNSAFE_getByType } = render(<HomeScreen onNavigateToSearch={noop} />);
  ...
  it('closes SearchBottomSheet via onClose and hides the sheet', async () => {
    const { getByText, UNSAFE_getByType, queryByPlaceholderText } = render(<HomeScreen onNavigateToSearch={noop} />);
    fireEvent.press(getByText('Buscar'));
  ...
  it('closes SearchBottomSheet when overlay is pressed and reopens on next Buscar press', async () => {
    const { getByText, getAllByText, getByPlaceholderText } = render(<HomeScreen onNavigateToSearch={noop} />);
