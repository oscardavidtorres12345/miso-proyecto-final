...
export function SearchSummaryBar({ params, onEditSearch }: SearchSummaryBarProps) {
  ...
  return (
    <TouchableOpacity style={styles.summary} onPress={onEditSearch} activeOpacity={0.75} testID="search-summary-bar" accessibilityRole="button" accessibilityLabel="Editar búsqueda">
