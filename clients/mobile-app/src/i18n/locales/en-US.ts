const enUS = {
  ...
  bookings: {
    ...
    manualCheckInCta: 'Manual check-in',
    manualCheckInTitle: 'Manual check-in',
    manualDocumentType: 'Document type',
    manualDocumentNumber: 'Document number',
    manualContactHint: 'Email',
    manualDocumentNumberPlaceholder: 'e.g. 1020304050',
    manualContactHintPlaceholder: 'email@example.com',
    documentTypeCC: 'National ID',
    documentTypePassport: 'Passport',
    manualCheckInConfirm: 'Confirm',
    manualCheckInRequired: 'Complete document number and contact.',
    manualInvalidEmail: 'Enter a valid email.',
