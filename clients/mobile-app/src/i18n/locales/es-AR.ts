const esAR = {
  ...
  bookings: {
    ...
    manualDocumentNumberPlaceholder: 'Ej: 30123456',
    manualContactHintPlaceholder: 'correo@ejemplo.com',
    documentTypeCC: 'DNI',
    ...
    manualInvalidEmail: 'Ingresá un correo válido.',
